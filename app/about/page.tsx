...
export default function AboutPage() {
  return (
    <div className="container px-4 py-8 md:px-6 md:py-12">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">About Pet Nest</h1>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
        <div>
          ...
          <p className="text-muted-foreground mb-4">
            Founded in 2015, Pet Nest started with a simple mission: to provide
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            At Pet Nest, our core values guide everything we do, from product
      ...
      <div className="mb-16">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            The passionate people behind Pet Nest who work tirelessly to bring
            the best products to you and your pets.
          </p>
        </div>
